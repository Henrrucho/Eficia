    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            ...
            <Footer>
                ...
                <FooterContainer>
                    <FooterItem onPress={() => router.push('/racha')}> <FontAwesome name="bell" size={35} /></FooterItem>
                </FooterContainer>
                <FooterContainer>
                    <FooterItem onPress={() => router.push('/historial')}> <FontAwesome name="list" size={35} /></FooterItem>
                </FooterContainer>
